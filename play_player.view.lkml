# This view is a rollup of stats up to the play level.
# Note that many players are involved in single plays so this took some finagling to get right from a modeling perspective.
# Also note the compound PK.
view: play_player {
